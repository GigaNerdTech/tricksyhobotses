...
async def on_message(message):
    ...
    if message.content.startswith('?'):
        ...
        if command == 'help' or command == 'info':
            ...
            output = subprocess.run(["/home/REDACTED/crystal/list.sh"], universal_newlines=True, stdout=subprocess.PIPE)
            ...
            copyfile("/home/REDACTED/crystal/" + crystal, "/home/REDACTED/crystal/crystal.jpg")
            await log_message("Picked crystal " + crystal_name)
            await message.channel.send("Name this crystal!",file=discord.File("/home/REDACTED/crystal/crystal.jpg"))
